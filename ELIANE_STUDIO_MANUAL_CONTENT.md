...
## Rencontre ton entraîneure

### Citation (encadré mauve)
...
```
→ Mettre en **gras** : `Au fil des années, j'ai appris que les résultats durables ne viennent pas d'une routine parfaite, d'un plan extrême ou d'une motivation constante.`
...
```
→ **Gras** : `Je ne suis pas là pour te donner un plan impossible à maintenir.`

**Ma spécialité** — coller tel quel.
...
```
→ **Gras** : `Mon but est de t'amener vers plus de clarté, de constance et d'autonomie.`
...
| Champ | Texte |
|-------|--------|
| Titre principal | `Un accompagnement personnalisé, du début à la fin.` → *italique mauve* sur `personnalisé` |
...
| Champ | Texte |
|-------|--------|
| Titre principal | `Ce qu'elles en disent.` → *italique mauve* sur `elles` |
